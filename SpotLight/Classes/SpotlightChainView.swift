...
final public class SpotlightChainView: SpotlightView {
    ...
    public func moveTo(_ to: Spotlight, duration: Double, completed: (() -> Void)? = nil) -> SpotlightChainView {
        return moveTo(to, duration: duration, curve: .liner, completed: completed)
    }
    
    public func moveTo(_ to: Spotlight, duration: Double, curve: SpotlightAnimationCurve = .liner, completed: (() -> Void)? = nil) -> SpotlightChainView {
    ...
    public func scaleTo(_ scale: CGFloat, duratoin: Double, curve: SpotlightAnimationCurve = .liner, completed: (() -> Void)? = nil) -> SpotlightChainView {
    ...
    public func breath(minScale: CGFloat, maxScale: CGFloat, duration: Double, repeatCount: Float, completed: (() -> Void)? = nil) -> SpotlightChainView {
    ...
    public func sleep(duration: Double) -> SpotlightChainView {
        return breath(minScale: 1, maxScale: 1, duration: duration, repeatCount: 1)
    }
